...
import ats.abongda.customClass.view.ScrimInsetsScrollView;
...
public class SlidingLayer extends FrameLayout {
    ...
    private ScrimInsetsScrollView.OnInsetsCallback mOnInsetsCallback;
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsDragging) {
                    ...
                    // LogUtil.d("Layer", String.format("Layer scrollX[%f],scrollY[%f]",
                    // scrollX, scrollY));
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mIsDragging) {
                    ...
                    mActivePointerId = INVALID_POINTER;
                    LogUtil.d("end drag from action up");
                    endDrag();
            ...
            case MotionEvent.ACTION_CANCEL:
                if (mIsDragging) {
                    ...
                    mActivePointerId = INVALID_POINTER;
                    LogUtil.d("end drag from action cancel");
                    endDrag();
                }
                break;
...
//		}
    ...
    public void setOnInsetsCallback(ScrimInsetsScrollView.OnInsetsCallback onInsetsCallback) {
